...
import com.nikeT.Service.ICategoriaService;
...
//Crud
    ...
    public String inicio(Model model) {
        List<Categoria> listaCategoria = categoriaService.getCategorias(true); // sino funcion en true cambielo a false para que se muestren las categorias
